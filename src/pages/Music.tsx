            ...
            {songs.map((song, index) => (
              <article key={song.title} className="grid grid-cols-1 overflow-hidden rounded-2xl border border-gold/20 bg-navy-card/55 shadow-xl shadow-black/20 lg:grid-cols-[1.05fr_0.95fr]">
                <div className={`p-6 sm:p-8 lg:p-10 ${index % 2 === 1 ? 'lg:order-2' : ''}`}>
                  ...
                  <p className="leading-relaxed text-[#ffffff]">{song.description}</p>
                </div>
        ...
        <div className="container-wide">
          ...
          <article className="grid grid-cols-1 items-stretch gap-0 overflow-hidden rounded-2xl border border-gold/20 bg-navy-card/55 shadow-xl shadow-black/20 lg:grid-cols-2">
            <div className="flex flex-col justify-center p-7 sm:p-10 lg:p-14">
              ...
              <p className="mb-5 leading-relaxed text-[#ffffff]">
              ...
              <p className="mb-6 leading-relaxed text-[#ffffff]">
          ...
          <article className="mt-12 grid grid-cols-1 overflow-hidden rounded-2xl border border-gold/20 bg-navy-card/55 shadow-xl shadow-black/20 lg:grid-cols-2">
            <div className="flex flex-col justify-center p-7 sm:p-10 lg:p-14">
              ...
              <p className="mb-5 leading-relaxed text-[#ffffff]">The song wasn’t written to become a hit record. It wasn’t created with a movie in mind, nor was it intended to launch a book. It was born from one of life’s most difficult experiences—a friendship tested by distance, a heartbreaking loss, and a promise that would remain in Larry B. Bachman’s heart for years.</p>
              <p className="mb-5 leading-relaxed text-[#ffffff]">Long before The Promise found its place in The Sparrows Nesting or inspired readers through The Lady and Jesse Make a Promise, it began in the quiet countryside of Pennsylvania. There, Larry spent countless hours studying the Bible with a close friend named Scott.</p>
              <p className="leading-relaxed text-[#ffffff]">Before Larry left Pennsylvania for an opportunity in California, the two friends made a simple promise: if anything should happen to either of them, somehow, some way, they would let the other know.</p>
            </div>
          ...
          <article className="mt-12 overflow-hidden rounded-2xl border border-gold/20 bg-navy-card/55 shadow-xl shadow-black/20">
            ...
            <div className="grid grid-cols-1 gap-10 p-7 sm:p-10 lg:grid-cols-2 lg:p-12">
              <div>
                ...
                <p className="mb-5 leading-relaxed text-[#ffffff]">The next morning, Larry drove to Scott’s apartment expecting to meet his friend for breakfast. Scott never answered the door. His girlfriend met Larry outside and quietly told him Scott had never come home the night before.</p>
                <p className="mb-5 leading-relaxed text-[#ffffff]">Finally, Larry returned home. As he walked through the door, his mother looked at him and said words he would never forget: “Larry, you need to sit down.” Then she told him, “Scott’s dead.”</p>
                <p className="leading-relaxed text-[#ffffff]">The news left Larry heartbroken. He served as one of the pallbearers at Scott’s funeral, carrying the burden of unanswered questions, regret, and the memory of their final conversation.</p>
              </div>
              <div>
                <h3 className="mb-5 font-serif text-3xl font-bold text-gold-light">The Dream</h3>
                <p className="mb-5 leading-relaxed text-[#ffffff]">Nearly a year passed before another unexpected chapter unfolded. A friend called Larry after experiencing a dream she simply couldn’t explain. In it, she saw Scott and later understood the words: “We’re sleeping. We’re waiting.”</p>
                <p className="mb-5 leading-relaxed text-[#ffffff]">Then she looked at Larry and said, “Scott wanted me to tell you.” The moment she spoke those words, Larry remembered the promise the two friends had made before California.</p>
                <p className="leading-relaxed text-[#ffffff]">For Larry, the experience wasn’t about sensationalism or trying to explain the unexplainable. It became another reminder of God’s providence and the hope found in His promises.</p>
              </div>
            </div>
          </article>
          ...
          <article className="mt-12 grid grid-cols-1 overflow-hidden rounded-2xl border border-gold/20 bg-navy-card/55 shadow-xl shadow-black/20 lg:grid-cols-2">
            <div className="flex flex-col justify-center p-7 sm:p-10 lg:p-12">
              ...
              <p className="mb-5 leading-relaxed text-[#ffffff]">Years later, while helping his son produce an album, Larry experienced another moment he believes was directed by God. As he reflected on the unfinished song If You Need a Friend, he sensed a clear impression on his heart: rewrite it. Turn it into a praise song.</p>
              <p className="leading-relaxed text-[#ffffff]">Within minutes, the message born out of grief became a testimony of faith. If You Need a Friend became The Promise—a song for anyone searching for hope, peace, and the assurance that God’s promises never fail.</p>
              <a
            ...
            <div className="grid grid-rows-[auto_1fr] bg-gold/5">
              ...
              <div className="p-7 sm:p-10 lg:p-12">
                ...
                <p className="leading-relaxed text-[#ffffff]">Not long afterward, a producer working on the feature film The Sparrows Nesting needed music for the soundtrack. Larry submitted The Promise. The song remained in the film, where it was performed by Shana Saint and introduced to audiences worldwide.</p>
              </div>
            </div>
          </article>
