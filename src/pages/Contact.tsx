    ...
    <div className="min-h-screen">
      ...
      <section className="relative pt-32 pb-20 bg-gradient-to-br from-navy via-navy-light to-navy">
        ...
        <div className="relative z-10 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <h1 className="text-5xl sm:text-6xl font-serif font-bold text-warm-white mb-6">Contact</h1>
            ...
            <div className="lg:col-span-2">
              ...
              <div className="flex items-start gap-4 mb-8">
                ...
                <div>
                  ...
                  <a href="mailto:info@larrybachman.com" className="text-gold hover:text-gold-light transition-colors text-sm">
                    info@larrybachman.com
                  </a>
                </div>
              </div>
              ...
              <div>
                ...
                <ul className="space-y-2">
                  {['Book Inquiry', 'Speaking / Appearance', 'Media & Press', 'Music & Licensing', 'General Message'].map((type) => (
                    <li key={type} className="flex items-center gap-2 text-sm text-warm-white/40">
            ...
            <div className="lg:col-span-3">
              {submitted ? (
                <div className="flex flex-col items-center justify-center text-center py-20 px-8 bg-navy-card/40 border border-gold/10 rounded-lg h-full">
                  ...
                  <p className="text-warm-white/40 leading-relaxed max-w-sm">
