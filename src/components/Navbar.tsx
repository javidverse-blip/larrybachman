...
export default function Navbar() {
  ...
  return (
    <header
      className={`fixed top-0 left-0 right-0 z-50 border-b border-gold/40 transition-all duration-500 ${
        scrolled || !hasTransparentHero || open
    ...
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16 md:h-20">
          ...
          <nav className="hidden xl:flex items-center gap-0">
            ...
            <Link
              to="/contact"
              className="ml-2 inline-flex items-center gap-2 bg-gold hover:bg-gold-light text-navy font-semibold px-5 py-2 rounded-sm transition-all duration-300 text-base"
            >
              Contact
            </Link>
          ...
          <button
            className="xl:hidden text-warm-white/70 hover:text-gold transition-colors p-2"
      ...
      {open && (
        <div className="xl:hidden bg-navy/98 backdrop-blur-md border-t border-gold/10 px-4 pb-6 pt-2">
          <nav className="flex flex-col gap-1">
            ...
            <Link
              to="/contact"
              className="mt-3 inline-flex items-center justify-center gap-2 bg-gold hover:bg-gold-light text-navy font-semibold px-5 py-3 rounded-sm transition-all duration-300 text-base"
            >
              Contact
            </Link>
